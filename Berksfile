...
# mapzen
cookbook 'sysctl'          , git: 'https://github.com/mapzen/chef-sysctl.git'            , branch: 'master'
...
cookbook 'mapnikwrap'      , git: 'https://github.com/mapzen/chef-mapnikwrap.git'        , branch: 'master'
cookbook 'postgresql'      , git: 'https://github.com/mapzen/chef-postgresql.git'        , tag: '0.13.0-187'
cookbook 'postgiswrap'     , git: 'git@github.com:mapzen/chef-postgiswrap.git'           , branch: 'master'
